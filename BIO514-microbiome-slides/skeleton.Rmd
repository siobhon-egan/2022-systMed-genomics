...
GitHub code repository `r top_icon("github")` [`siobhon-egan/2022-systMed-genomics`](http://github.com/siobhon-egan/2022-systMed-genomics)          
Website with information & tutorials `r top_icon("link")` [`siobhonlegan.com/2022-systMed-genomics`](http://siobhonlegan.com/2022-systMed-genomics)
...
In the **data/BIO514/** directory you will find:
...
otu_table <- read_csv("../data/BIO514/otu_table.csv", skip = 1, col_names=FALSE)
...
```{r include=FALSE}
# read data
tax_table <- read_csv("../data/BIO514/tax_table.csv")
...
```{r, eval=TRUE}
load("../data/BIO514/PBS_data.Rdata")
...
## Betadiversity `r top_icon("chart-bar")`
...
.white[`r top_icon("paper-plane")` siobhon.egan@murdoch.edu.au]
</a>

<a href="http://siobhonlegan.com/2022-systMed-genomics">
.white[`r top_icon("link")` siobhonlegan.com/2022-systMed-genomics]
</a>

<a href="http://siobhon-egan.github.io/2022-systMed-genomics">
.white[`r top_icon("github")` siobhon-egan.github.io/2022-systMed-genomics]
</a>
