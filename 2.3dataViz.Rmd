...
```{r, fig.width=12, fig.height=8, fig.cap="Rarefaction of final taxonomic data from microbiome analysis"}
# set seed
set.seed(1)
# set subsample
...
Produce alpha diversity plots using 6 measures.
...
```{r, fig.width=12, fig.height=8, fig.cap="Alpha diveristy analysis using Observed, Chao1, ACE, Shannon, Simpson and Inverse Simpson metrics"}
...
```{r distrib, message=FALSE, warning=FALSE, results='hide'}
# Bariatric Surgery
